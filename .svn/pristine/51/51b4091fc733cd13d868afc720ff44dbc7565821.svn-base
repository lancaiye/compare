...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/test/testData/">test列表</a></li>
		<li class="active"><a href="${ctx}/oa/test/testData/form?id=${testData.id}">test<shiro:hasPermission name="oa:test:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:test:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/oa/test/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:test:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
